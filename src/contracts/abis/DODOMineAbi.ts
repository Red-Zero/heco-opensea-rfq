export default [
  {
    inputs: [
      { internalType: "address", name: "_dodoToken", type: "address" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "accDODOPerShare", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_dodoPerBlock", type: "uint256" },
      { internalType: "bool", name: "_withUpdate", type: "bool" },
    ],
    name: "setReward",
    outputs: [],
